 ...
 * bold-italic in TEAL #09b5b7, Poppins bold. Emphasis words appear solo; some
...
import {PLAYFAIR, POPPINS, loadCenaRaizFonts} from './fonts';
...
const ORANGE =
  ((editData as {captions?: {accent?: string}}).captions?.accent ?? '#09b5b7');
