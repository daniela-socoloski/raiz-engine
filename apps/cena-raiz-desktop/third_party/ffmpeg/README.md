# FFmpeg no cena-raiz Desktop

O cena-raiz fixa o FFmpeg e o FFprobe na versao `8.1.2`. O codigo-fonte oficial,
...
O pipeline atual do cena-raiz chama o encoder `libx264`. No FFmpeg, habilitar esse
...
parametros de renderizacao do cena-raiz, pois `preset` e `crf` do `libx264` nao se
