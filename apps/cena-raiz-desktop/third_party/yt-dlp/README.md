# yt-dlp no cena-raiz Desktop

O cena-raiz empacota o binario oficial standalone do yt-dlp na versao `2026.07.04`.
...
O cena-raiz nao executa a atualizacao automatica do sidecar. Novas versoes devem ser
