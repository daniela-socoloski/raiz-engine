#!/usr/bin/env python3
"""
Coleta as postagens recentes de um Instagram para o marca-raiz.
...
Uso (a partir da pasta-raiz do sistema):
  python3 scripts/collect-instagram.py \
    --profile nowdays \
    --project "projetos/nowdays" \
    --limit 50
"""
...
def ensure_instaloader() -> Any:
    try:
        ...
        if os.environ.get("HUMAN_marca-raiz_INSTAGRAM_VENV") != "1":
            ...
            env = os.environ.copy()
            env["HUMAN_marca-raiz_INSTAGRAM_VENV"] = "1"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Coleta até 50 posts recentes de Instagram para discovery do marca-raiz.")
    parser.add_argument("--profile", required=True, help="@handle ou URL do Instagram")
    parser.add_argument("--project", required=True, help="Pasta do projeto marca-raiz")
