...
Por isso este documento tem seção 15 inteira dedicada a anti-padrões. Por isso o marca-raiz.md tem seção 3.5 e 12 dedicadas a anti-referências. Não é negativismo — é repertório.
...
- **Geração de design tokens** pra marca-raiz.md
- **Resposta a perguntas tipo "isso é bom design?"** ou "isso vai funcionar?"
- **Análise de referências visuais** que a pessoa jogou em `referencias/`
...
2. Ler marca-raiz.md atual (seção 3 — Estilo visual)
3. Ler referências visuais em `referencias/`
...
### Antes de gerar design tokens pro marca-raiz.md
