...
- marca-raiz com `brand_aesthetic_anchor` preenchido (Pergunta 42 do Discovery)
...
## marca-raiz da marca (variáveis-base)
...
Se mudar `brand_aesthetic_anchor` no marca-raiz, atualize também o prompt da Routine R1. Próxima run usa novo critério.
