...
export type GeminiAgentDeps = {
  ...
  authFile: string;
  // Settings de SISTEMA controladas pelo CenaRaiz (GEMINI_CLI_SYSTEM_SETTINGS_PATH):
...
export class GeminiAgent {
  ...
  async sendMessage(
    ...
    const prompt = session.instructed
      ? text
      : `Instruções do CenaRaiz — valem para a sessão inteira:\n${CENA_RAIZ_INSTRUCTIONS}${GEMINI_EXTRA_INSTRUCTIONS}\n\n---\n\nMensagem do aluno:\n${text}`;
