...
// Login de membro (Supabase proprio). "unconfigured" = app sem as
...
// API); o CenaRaiz guarda as credenciais de cada um e QUAL provedor cumpre cada
...
export type CenaRaizDesktopApi = {
