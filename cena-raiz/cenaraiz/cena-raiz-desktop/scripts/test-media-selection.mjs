...
// real "teste cena-raiz desktop", onde a Fase 2 ficava invisivel porque o corte
...
const outDir = mkdtempSync(path.join(tmpdir(), 'cena-raiz-media-test-'));
...
try {
  ...
  // --- Caso real: projeto "teste cena-raiz desktop" apos aplicar a Fase 2 -------
