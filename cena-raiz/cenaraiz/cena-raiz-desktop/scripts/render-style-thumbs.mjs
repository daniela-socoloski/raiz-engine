...
const runtimeNode = path.join(
  os.homedir(),
  'Library', 'Application Support', 'CenaRaiz', 'runtime', 'remotion', 'node_modules',
);
...
// Com CENA_RAIZ_THUMBS_REUSE=1 os renders existentes sao reaproveitados e so os
// recortes rodam — iteracao de enquadramento em segundos.
const reuse = process.env.CENA_RAIZ_THUMBS_REUSE === '1' && existsSync(stills);
