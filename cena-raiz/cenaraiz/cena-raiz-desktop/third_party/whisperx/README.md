# Python e WhisperX no cena-raiz Desktop

O cena-raiz empacota CPython `3.12.13` e WhisperX `3.8.6`. O Python portatil e uma
...
FFmpeg/FFprobe principal do cena-raiz continua sendo `8.1.2`, com os recursos de
...
cena-raiz, fora do pacote assinado, e reutilizados entre atualizacoes do aplicativo.
