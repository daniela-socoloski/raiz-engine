...
import {POPPINS, loadCenaRaizFonts} from './fonts';
...
export type EditData = {
  ...
  hook: {
    ...
    // blocos) e "misto" (segunda linha). Default: laranja do CenaRaiz.
    accent?: string;
  ...
  // CenaRaiz le estas janelas para desenhar a track de Animacoes.
...
// Cor de destaque padrao do CenaRaiz, usada quando o edit-data.json nao traz uma.
...
export const CENA_RAIZ_ACCENT = '#09b5b7';
...
const HookInner: React.FC<{totalFrames: number}> = ({totalFrames}) => {
  ...
  const accent = H.accent ?? CENA_RAIZ_ACCENT;
