...
A skill CenaRaiz transcreve com helpers/transcribe.py, que emite uma lista `words`
no topo do arquivo, cada palavra com `type`, `text`, `start` e `end`. O cena-raiz-desktop transcreve com o WhisperX empacotado (`python3 -m whisperx
